...
class JaktaIncarnation<P> : Incarnation<Any?, P> where P : Position<P> {
    ...
    override fun createNode(
        ...
        val jaktaDevice = JaktaEnvironmentForAlchemist(environment, randomGenerator, it)
        it.addProperty(jaktaDevice)
        it.addProperty(JaktaForAlchemistMessageBroker(jaktaDevice))
    }
