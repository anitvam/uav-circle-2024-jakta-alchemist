...
//    private fun <T : Any, P : Position2D<P>> fixDeserialization(environment: Environment<T, P> ) {
//        positionsMemory = positionsMemory.map { (id, positions) ->
//            val newPositions: List<Pair<Position2D<*>, Double>> = positions.map { (positionObj: Any, value: Double) ->
//                val truePosition = when (positionObj) {
//                    is Map<*, *> -> {
//                        val coordinatesAsMap = positionObj as Map<String, List<Double>>
//                        val coordinates = coordinatesAsMap["c"]!!
//                        environment.makePosition(coordinates.first(), coordinates[1])
//                    }
//                    is Position2D<*> -> positionObj
//                    else -> error("sadasdsdsafsgfmrklgn")
//                }
//                truePosition to value
//            }
//            id to newPositions
//        }.toMap()
//    }
...
//        fixDeserialization(environment)
    ...
    private fun <P : Position2D<P>> drawTrajectory(
        ...
        var positions: List<Pair<Position2D<*>, Double>> = positionsMemory[node.id].orEmpty()
